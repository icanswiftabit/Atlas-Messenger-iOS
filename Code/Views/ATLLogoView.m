...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        NSMutableAttributedString *atlasString = [[NSMutableAttributedString alloc] initWithString:@"LARRY MESSENGER"];
        [atlasString addAttribute:NSFontAttributeName value:ATLMLightFont(18) range:NSMakeRange(0, atlasString.length)];
