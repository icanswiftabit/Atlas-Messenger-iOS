...
- (id<ATLMRESTEndpoint>)RESTEndpoint {
    id<ATLMAuthenticating> provider = [self authenticationProvider];
    return ([provider conformsToProtocol:@protocol(ATLMRESTEndpoint)] ? (id<ATLMRESTEndpoint>)provider : nil);
}
